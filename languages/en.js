...
module.exports = {
  ...
  CONTROLLING: (possibleCommands) => {
    return newLiner(
      ...
      `All audio enchantments are courtesy of Michael Ghelfi Studios, ensuring a truly immersive experience. 🎵✨\n`,
      `So, adventurers, let's embark on an epic quest filled with magical melodies and wondrous soundscapes! 🚀🔊\n`,
      `__**Try it now:**__\n`,
